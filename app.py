...
def file_split(input_file, diarization_file, output_path):
    ...
    for g in groups:
        ...
        gidx += 1
        audio[start:end].export(output_path + str(gidx) + '.wav', format='wav')
...
def transcribe(groups, output_path): 
